<template>
  <div id="addUser">
    ...
    <div class="form-addUser">
      <el-form status-icon :model="addUser" :rules="rules" ref='addUser'  label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="用户名" prop='username'>
          <el-input type="text" v-model='addUser.username' @blur='regUsername' autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="昵称" prop='nickname'>
          <el-input type="text" v-model='addUser.nickname' @blur='regNickname' autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop='password'>
          <el-input type="password" v-model='addUser.password' @blur="regPasw1"  autocomplete="off"></el-input>
          <!-- <el-span style='color:#f00'>6-16个字符</el-span> -->
        </el-form-item>
        <el-form-item label="确认密码" prop='resetPassword'>
          <el-input type="password" v-model='addUser.resetPassword' @blur="regPasw2"  autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="手机" prop='userTel'>
          <el-input type="tel" v-model.number='addUser.userTel' @blur="regTel"  autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop='email'>
          <el-input type="email" v-model='addUser.email' @blur="regEmail" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="选择日期" required >
          <el-date-picker type="date" placeholder="选择日期" v-model="addUser.dateTime" style="width: 60%;"></el-date-picker>
        </el-form-item>
...
export default {
  ...
  methods:{
    ...
    regEmail(){
      if(!/^[a-z0-9][\w\-\.]{2,29}@[a-z0-9\-]{2,67}(\.[a-z\u2E80-\u9FFF]{2,6})+$/.test(this.addUser.email)){
    ...
    Submit(formName){
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$axios.post('/admin/user/doUserAdd',{
