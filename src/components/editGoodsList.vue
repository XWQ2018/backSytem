    ...
    <div class="form-update">
      <el-form status-icon  label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="添加时间">
          <el-date-picker type="date" placeholder="选择日期" v-model="productList.dateTime" style="width: 60%;"></el-date-picker>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods:{
    sbmit(){
      ...
      if(ID!='' && name!='' && list!='' && dateTime!='' && price!=''){
        this.$axios.post('/admin/product/editGoodsList',{
          id:_id,
          goodsListInfo:{
            ID,
            name,
